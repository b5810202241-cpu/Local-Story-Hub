...
- เผยแพร่ผลงานนิสิต (`student-publish.html`): ตรวจสอบฟอร์ม (ต้องกรอกชื่อผลงานก่อน) แล้วแสดงหน้าจอสำเร็จจริงเมื่อ "ส่งขออนุมัติ" (ไม่ใช่เผยแพร่ทันที — แก้ไข 2026-09-04)
...
| ไฟล์ | อ้างอิง | หมายเหตุ |
|---|---|---|
| `student-publish.html` | FR-3.1 | DRAFT — วิธีเชื่อมโยงกับชุมชนยังไม่ปิด · **แก้ไข 2026-09-04**: ตอนนี้ต้องผ่านการอนุมัติจากอาจารย์ก่อนเผยแพร่ (กลับคำตัดสินใจเดิม) — หน้านี้ยังไม่มีหน้าจอฝั่งอาจารย์สำหรับอนุมัติ/ไม่อนุมัติ |
