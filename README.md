...
โปรเจกต์นี้บริหารจัดการด้วย docs pipeline แบบ Obsidian vault ตั้งแต่ requirement ไปจนถึง retrospective — ดูรายละเอียดทั้งหมดที่ [CLAUDE.md](CLAUDE.md) และ [docs/](docs/)
